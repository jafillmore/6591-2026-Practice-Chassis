...
public class DriveSubsystem extends SubsystemBase {
 ...
 m_pidgey.getAngularVelocityZDevice().setUpdateFrequency(100);
 m_pidgey.getGravityVectorZ().setUpdateFrequency(100);  
  ...
  public void driveDebugInfo(){
    if (driveSystemDebug) {
      // IMU Status
        SmartDashboard.putNumber(   "IMU Yaw Rate (DPS)", m_pidgey.getAngularVelocityZDevice().getValueAsDouble());
